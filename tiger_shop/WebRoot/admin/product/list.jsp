...
&#28155;&#21152;
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="p" value="pageBean.beanList" status="status">
				...
				<tr>	
					...
					<s:if test="pageBean.page > 1">
						<a href="${pageContext.request.contextPath }/adminProduct_findAll.action?page=1"><strong>首页</strong></a>|&nbsp;
					...
					<s:if test="pageBean.page < pageBean.totalPage">
						...
						<a href="${pageContext.request.contextPath }/adminProduct_findAll.action?page=<s:property value="pageBean.totalPage"/>"><strong>尾页</strong></a>
					</s:if>
					</td>
				</tr>
			</table>
