...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addUser(){
				window.location.href = "${pageContext.request.contextPath}/adminCategorySecond_preAdd.action";
			}
		</script>
	</HEAD>
	<body>
...
&#28155;&#21152;
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="cs" value="pageBean.beanList" status="status">
				...
				<tr>	
					...
					<s:if test="pageBean.page > 1">
						<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll.action?page=1"><strong>首页</strong></a>|&nbsp;
					...
					<s:if test="pageBean.page < pageBean.totalPage">
						...
						<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll.action?page=<s:property value="pageBean.totalPage"/>"><strong>尾页</strong></a>
					</s:if>
					</td>
				</tr>
			</table>
