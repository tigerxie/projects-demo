		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					...
					<s:iterator var="ci" value="#session.cart.cartItems">
						<tr>
							<td width="60">
								<input type="hidden" name="id" value="22">
								<img src="${pageContext.request.contextPath }/<s:property value="#ci.product.image"/>">
							</td>
							<td>
								<a target="_blank"> <s:property value="#ci.product.pname"/></a>
							</td>
							<td>
							...
							<td>
								<a href="${pageContext.request.contextPath }/cart_removeCartItem.action?pid=<s:property value="#ci.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
					</s:iterator>
				</tbody></table>
